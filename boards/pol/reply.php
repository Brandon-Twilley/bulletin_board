...
include('../../functions.php');
    ...
    function reply_thread($name, $subject, $post, $thread) {
        ...
        $sql = 'INSERT INTO pol_'.$thread.' (mess_id, name, message_text, time) VALUES ("'.$post_count.'", "'.$name.'", "'.$post.'", "'.$timestamp.'")';
    ...
    header('Location: localhost:8888/boards/pol/?thread='.$_POST['thread']);
    exit();
?>